...
class MagicBallScreenMobileBody extends StatefulWidget {
  const MagicBallScreenMobileBody({super.key});

  @override
  State<MagicBallScreenMobileBody> createState() => _MagicBallScreenMobileBodyState();
}

class _MagicBallScreenMobileBodyState extends State<MagicBallScreenMobileBody> {
